    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10 py-20 md:py-32 px-4 text-center">
        ...
        <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8 animate-fade-in" style={{animationDelay: "0.2s"}}>
          От игры на гитаре до сантехники — каждый может стать как учеником, так и наставником. Простая платформа для обмена практическими знаниями.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in" style={{animationDelay: "0.4s"}}>
          <Button size="lg" className="w-full sm:w-auto text-base px-8 py-6 bg-white text-primary hover:bg-white/90">
            Найти навык
          </Button>
          <Button size="lg" variant="outline" className="w-full sm:w-auto text-base px-8 py-6 bg-transparent border-white text-white hover:bg-white/10">
            Стать учителем
          </Button>
        </div>
        ...
        <div className="mt-12 flex justify-center items-center gap-8 animate-fade-in" style={{animationDelay: "0.6s"}}>
          <div className="text-center">
            ...
            <p className="text-white/80">Навыков</p>
          </div>
          <div className="text-center">
            <p className="text-3xl font-bold text-white">500+</p>
            <p className="text-white/80">Учителей</p>
          </div>
          <div className="text-center">
            <p className="text-3xl font-bold text-white">10000+</p>
            <p className="text-white/80">Учеников</p>
          </div>
        </div>
      </div>
    </section>
